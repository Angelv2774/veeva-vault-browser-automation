/**
 * basic-login.js — Basic login example for Veeva Vault
...
async function main() {
  ...
  try {
    log('Starting Veeva Vault automation (Open Source mode)');
    ...
    const result = await login_vault(page, {
    ...
    // const data = await upload_document(page, {});
    // log('Data:', data);
